...
ActiveRecord::Schema[7.0].define(version: 2022_08_11_103849) do
  ...
  create_table "post_ereas", force: :cascade do |t|
    t.bigint "area_id", null: false
    t.bigint "post_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["area_id"], name: "index_post_ereas_on_area_id"
    t.index ["post_id"], name: "index_post_ereas_on_post_id"
  end
  ...
  add_foreign_key "post_ereas", "areas"
  add_foreign_key "post_ereas", "posts"
